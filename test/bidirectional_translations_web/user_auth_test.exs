defmodule BidirectionalTranslationsWeb.UserAuthTest do
  ...
  alias BidirectionalTranslationsWeb.UserAuth

  import BidirectionalTranslations.AccountsFixtures
  ...
  describe "logout_user/1" do
    ...
    test "broadcasts to the given live_socket_id", %{conn: conn} do
      ...
      BidirectionalTranslationsWeb.Endpoint.subscribe(live_socket_id)
