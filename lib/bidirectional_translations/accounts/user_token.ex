defmodule BidirectionalTranslations.Accounts.UserToken do
  use Ecto.Schema
  import Ecto.Query
  alias BidirectionalTranslations.Accounts.UserToken
  ...
  schema "users_tokens" do
    ...
    belongs_to :user, BidirectionalTranslations.Accounts.User
