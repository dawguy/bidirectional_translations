defmodule BidirectionalTranslations.Application do
  ...
  def start(_type, _args) do
    ...
    opts = [strategy: :one_for_one, name: BidirectionalTranslations.Supervisor]
  ...
  def config_change(changed, _new, removed) do
    BidirectionalTranslationsWeb.Endpoint.config_change(changed, removed)
    :ok
  end
end
